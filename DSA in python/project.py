...
class WelcomePage(tk.Frame):
    def __init__(self, root, switch_to_main, bg_image):
        ...
        welcome_label = tk.Label(self, text="Welcome to the Hospital Route Finder", font=("Helvetica", 24, "bold"), bg="#ffffff", fg="#333333")
        welcome_label.place(relx=0.5, rely=0.3, anchor="center")  # Center the label

        # Add the proceed button
        proceed_button = tk.Button(self, text="Proceed to Route Map", font=("Helvetica", 16), bg="maroon", fg="white", command=switch_to_main)
        proceed_button.place(relx=0.5, rely=0.5, anchor="s")  # Center the button
